export default {
  ...
  testimonials: {
    ...
    question: 'Want to experience the benefits of SmartZap?',
    button: 'I want to try for free',
    images: [
  ...
  setup: {
    title: 'Start Using SmartZap Today:',
    steps: [
      {
        number: '1',
        title: 'Create Your Account',
        description: 'Sign up quickly and access all SmartZap features.',
        button: 'Create Account',
      },
      {
        number: '2',
        title: 'Configure and Use',
        description: 'Complete the initial setup and start using SmartZap to manage your leads.',
      },
    ],
  ...
  faqs: {
    ...
    questions: [
      ...
      {
        question: 'Can I use SmartZap on mobile devices?',
        answer: 'Yes, SmartZap is compatible with mobile browsers.',
      },
      {
      ...
      },
      {
        ...
        answer: 'Yes, SmartZap supports integrations with various platforms like Google Calendar, Zapier, and more.',
      },
      {
  ...
  bannerPrincipal: {
    title: 'Transform Your WhatsApp into a Sales Machine!',
